---
title: "使用 Kimi CLI 调用 Kimi 大模型"
sidebarTitle: "Kimi CLI 使用"
---
...
![](/assets/pics/kimi-cli/hello.png)
...
![](/assets/pics/kimi-cli/setup.png)

* Kimi For Coding 会员权益用户，选择第一个「Kimi For Coding 」，在随后的提示中，输入在会员页面获得的 API Key，并选择 `kimi-for-coding` 模型；Moonshot AI 开放平台用户，根据提示选择对应的平台，输入 API Key 并选择想要使用的模型。[查看 Kimi For Coding 会员权益说明](https://www.kimi.com/coding/docs/benefits.html)
...
![](/assets/pics/kimi-cli/zsh-integration.png)
...
![](/assets/pics/kimi-cli/zed-new-thread.png)
