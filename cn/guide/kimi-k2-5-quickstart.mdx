...
在 [chat](/api/chat) 文档中有一系列参数，但对于 K2.5 系列模型，其行为会有所不同。
...
<Note>
  完整的定价页面，包括其他模型系列和计费说明，请查看 [对话模型定价](/pricing/chat)。
</Note>

## 了解更多

- 使用 Kimi K2.5 进行基准测试，请参考这篇 [基准测试最佳实践](/guide/benchmark-best-practice)
- Kimi K2.5 的最详细的 API 使用示例请见：[使用 Kimi 视觉模型](/guide/use-kimi-vision-model)
