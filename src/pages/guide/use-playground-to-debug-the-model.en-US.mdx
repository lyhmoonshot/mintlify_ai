...
- Note: The web_search tool calls Kimi Open Platform's web search service. Single web searches are billed, see [Pricing](/docs/pricing/tools) for specific billing standards
