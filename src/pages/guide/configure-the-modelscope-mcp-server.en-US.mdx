...
First, log in to Kimi Playground: [https://platform.moonshot.ai/playground](https://platform.moonshot.ai/playground) and ensure you can have basic conversations using the Kimi K2 model.
...
![mcp-list](/docs/guide/modelscope/mcp-list-en.png)
...
![add-mcp](/docs/guide/modelscope/add-mcp-en.png)
...
![manage-mcp](/docs/guide/modelscope/manage-mcp-en.png)