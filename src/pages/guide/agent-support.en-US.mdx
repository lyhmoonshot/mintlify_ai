...
## Obtaining API Key
* Visit the Open Platform at https://platform.moonshot.ai/console/api-keys to create and obtain an API Key, selecting the default project.
...
![moonshot_cline](/docs/guide/cline/moonshot_cline_en.png)
...
3. Run `opencode` to launch OpenCode.
   ...
   Use the `/models` command to select a model like _Kimi K2.5_ or _Kimi K2 Turbo_ .
   _Kimi K2.5_ is the official kimi-k2-0905-preview model, and _Kimi K2 Turbo_ is the official kimi-k2-turbo-preview model.
...
Where $MOONSHOT_API_KEY needs to be replaced with the API Key you created on the platform.                                
