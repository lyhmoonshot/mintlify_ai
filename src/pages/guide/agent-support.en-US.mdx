...
![status](/pics/cline/thinking-on.png)
...
![cline](/pics/cline/search_cline.jpeg)
...
![moonshot\_cline](/pics/cline/moonshot_cline_en.png)
...
<div style={{ maxWidth: '100%', margin: '20px 0' }}>
  <video controls style={{ width: '100%', height: 'auto' }}>
    <source src="/pics/cline/cline-run.mp4" type="video/mp4" />
...
<div style={{ maxWidth: '100%', margin: '20px 0' }}>
  <video controls style={{ width: '100%', height: 'auto' }}>
    <source src="/pics/cline/snake.mp4" type="video/mp4" />
...
![cline](/pics/cline/search_roocode.png)
...
![roocode](/pics/cline/moonshot_roocode_en.png)
...
![opencode](/pics/cline/opencode.jpeg)
