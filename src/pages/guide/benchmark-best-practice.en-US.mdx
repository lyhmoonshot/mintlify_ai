...
<table className="nextra-table">
  <thead>
    <tr>
      <th>Benchmark Category</th>
      <th>Benchmark</th>
      <th>Temperature</th>
      <th style={{ width: '210px' }}>Recommended max tokens</th>
      <th>Recommended runs</th>
      <th>Top-p</th>
      <th>Others (e.g. test log)</th>
    </tr>
  </thead>
  <tbody>
    <tr>
...
For third-party providers, refer to Kimi Vendor Verifier (KVV) to choose high-accuracy services. Details: https://kimi.com/blog/kimi-vendor-verifier.html
...
<table className="nextra-table">
  <thead>
    <tr>
      ...
      <th>Benchmark</th>
      <th>Temperature</th>
      <th style={{ width: '210px' }}>Max token</th>
      <th>Suggested runs</th>
      <th>Notes</th>
    </tr>
  </thead>
  <tbody>
