---
title: "Kimi K2.5 Multi-modal Model"
---

import { Tabs } from 'nextra/components'
import { KimiK25Price } from '@/dynamic'
...
<div style={{ maxWidth: '100%', margin: '20px 0' }}>
  <video controls style={{ width: '100%', height: 'auto' }}>
    <source src="/pics/test_video.mp4" type="video/mp4" />
  </video>
</div>
...
Image and video token usage is dynamically calculated. You can use the [token estimation API](../api/estimate.mdx) to check the expected token consumption for a request containing images or video before processing.
...
For token pricing details, refer to [Model Pricing](../pricing/chat.mdx).
...
Parameters are listed in [chat](../api/chat.en-US.mdx#request-body). However, behaviour of some parameters may be different in k2.5 models.
...
You can refer to [Use Thinking Models](/docs/guide/use-kimi-k2-thinking-model.mdx) for correct usage of tool calling.
...
- For the benchmark testing with Kimi K2.5, please refer to this [benchmark best practice](./benchmark-best-practice.mdx)
- For the most detailed API usage example of Kimi K2.5, see: [How to Use Kimi Vision Model](./use-kimi-vision-model.mdx)
- See [How to Use Kimi K2 in Claude Code, Roo Code, and Cline](./agent-support.mdx)
- Learn how to configure and use the [Thinking Model](/docs/guide/use-kimi-k2-thinking-model.mdx)
- Web search is a powerful official tool provided by the Kimi API. See how to use [Web Search](./use-web-search.mdx) and other [official tools](./use-formula-tool-in-chatapi.mdx).
- For all model pricing see [here](/docs/pricing/chat.mdx), [Billing & Rate Limit details](/docs/pricing/limits.mdx), and [Web Search Pricing](/docs/pricing/tools.mdx)