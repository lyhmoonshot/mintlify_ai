---
title: "Use Kimi K2.5 Model to Setup Agent"
---
...
| code\_runner | Python code execution tool |
...
Before you start, please make sure to configure your API\_KEY as an environment variable:
...
The case code above is just a simple trial that still needs supplementation and improvement, so you may encounter some issues when running it. Solutions to these problems can be found below _(continuously updated)_:
...
![nasdaq\_2025\_performance](/docs/guide/nasdaq_2025_performance.png)
