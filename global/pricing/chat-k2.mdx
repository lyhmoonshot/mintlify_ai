...
- Supports automatic context caching functionality. Cached tokens are charged at the input price (cache hit) rate. You can view "context caching" type cost details in the [console](https://platform.kimi.ai/console)
