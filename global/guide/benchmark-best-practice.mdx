...
**A.** Your API account has specific rate limits (see [Recharge and Rate Limits](https://platform.kimi.ai/pricing/limits)). Start low. If you hit **HTTP 429** (rate limit), your concurrency is too high. **Accuracy \> speed,** so tune concurrency to stay within limits.
