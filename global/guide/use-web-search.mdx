...
sidebarTitle: "Use the Web Search Tool"
---
...
In addition to token consumption, we also charge a call fee for each web search, priced at \$0.005. For more details, please refer to [Pricing](/pricing/tools).
