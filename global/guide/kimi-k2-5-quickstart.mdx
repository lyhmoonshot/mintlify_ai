---
title: "Kimi K2.5"
sidebarTitle: "Kimi K2.5 Multi-modal Model"
---

## Overview of Kimi K2.5 Model

Kimi K2.5 is Kimi's most intelligent model to date, achieving open-source SoTA performance in Agent, code, visual understanding, and a range of general intelligent tasks. It is also Kimi's most versatile model to date, featuring a native multimodal architecture that supports both visual and text input, thinking and non-thinking modes, and dialogue and Agent tasks. [Tech Blog](https://www.kimi.com/blog/kimi-k2-5.html)

![kimi-k2.5](/assets/pics/k25-en.png)
...
- [Try it now](/playground): Test model performance in your business scenarios through interactive operations in the Dev Workbench
- [Apply for API Key](/console/api-keys): Test via API call immediately
...
Image and video token usage is dynamically calculated. You can use the [token estimation API](/api/estimate) to check the expected token consumption for a request containing images or video before processing.
...
For token pricing details, refer to [Model Pricing](/pricing/chat-k25).
...
You can refer to [Use Thinking Models](/guide/use-kimi-k2-thinking-model) for correct usage of tool calling.
...
<Info>
  For the full pricing page, including other model families and billing notes, see [Chat Pricing](/pricing/chat).
</Info>

## Learn More

- For the benchmark testing with Kimi K2.5, please refer to this [benchmark best practice](/guide/benchmark-best-practice)
- For the most detailed API usage example of Kimi K2.5, see: [How to Use Kimi Vision Model](/guide/use-kimi-vision-model)
- See [How to Use Kimi K2 in Claude Code, Roo Code, and Cline](/guide/agent-support)
- Learn how to configure and use the [Thinking Model](/guide/use-kimi-k2-thinking-model)
- Web search is a powerful official tool provided by the Kimi API. See how to use [Web Search](/guide/use-web-search) and other [official tools](/guide/use-official-tools).
- For all model pricing see [here](/pricing/chat), [Billing & Rate Limit details](/pricing/limits), and [Web Search Pricing](/pricing/tools)
