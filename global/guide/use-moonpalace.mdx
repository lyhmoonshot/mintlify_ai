...
sidebarTitle: "Use the API Debugging Tool"
---
...
_If you still cannot find the `moonpalace` binary file, try adding the `$GOPATH/bin/` directory to your `$PATH` environment variable._
